...
Original GoLegacy credits:
| Name         | Contribution         |
| ------------ | -------------------- |
| VisualPlugin | GoAnimate GoLegacy    |
...
Developers will have (D) on their name, to show they are officially working on GoLegacy: Offline. Everyone else has simply contributed something at some point.
GoLegacy: Offline credits:
| Name            | Contribution                     |
| --------------- | -------------------------------- |
| Benson (D)      | GoLegacy: Offline                 |
| NathanTDA       | Logo                             |
...
These are unaffiliated people that they haven't directly done anything for the project (and probably don't even know it exists) but still deserve credit for their things. Kinda like a shoutout but in a project's readme. ***Please do not contact them about GoLegacy: Offline.***
| Name               | Contribution                     |
| ------------------ | -------------------------------- |
