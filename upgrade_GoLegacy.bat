:: Automatically upgrades an existing GoLegacy install to a new version
...
if not exist start_GoLegacy.bat ( goto error_location )
goto noerror_location
:error_location
echo Doesn't seem like this script is in the GoLegacy: Offline folder.
echo Please move it to the same folder as start_GoLegacy.bat
goto end
:noerror_location
...
echo in the same folder as start_GoLegacy.bat and this script.
echo:
goto end
:noerror_noupdate
...
title Upgrading GoLegacy: Offline to !GoLegacy_NEWVER!

echo Would you like to upgrade to !GoLegacy_NEWVER!?
...
echo Doing so may ruin your copy of GoLegacy: Offline.
