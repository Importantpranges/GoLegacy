title GoLegacy Settings Script
...
:error_location
echo Doesn't seem like this script is in the GoLegacy folder.
goto end
:noerror_location
...
:: Waveforms
if exist "GoLegacy\static\info-nowave.json" (
...
if exist "server\characters\characters.zip" (
	...
	if "!choice!"=="?6" (
		echo When first getting GoLegacy: Offline, all non-stock characters are put into a single zip file.
